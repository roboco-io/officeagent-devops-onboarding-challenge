...
3. **발표 자료 (`deck/`)** — 30분 발표 + 30분 Q&A. 핵심 의사결정 3~5개 트레이드오프 표
4. **회고 (`retros/`)** — Retrobot 자동 생성 또는 수동 학습 일지
...
| 영역 | 비중 |
|------|------|
| 마이그레이션 설계 · 의사결정 (깊이 다룬 도메인 2개) | 35% |
| 조사 · 학습 깊이 (1차 자료 인용, 대안 비교, 리스크·검증 계획) | 25% |
| 멀티 환경 추상화 사고 (다이어그램·모듈, NHN-only 식별) | 25% |
| 발표 · 소통 (30분 Q&A 응답 깊이, 미해결 위험 솔직성) | 15% |
